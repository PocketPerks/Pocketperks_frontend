...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-200 shadow-md transition-shadow">
      <div className="container mx-auto flex justify-between items-center px-6 py-3">
        ...
        <div
          className={`flex-col md:flex-row md:flex items-center md:space-x-8 text-gray-700 font-medium absolute md:static top-full left-0 right-0 bg-white/95 backdrop-blur-lg border-b md:border-0 border-gray-200 shadow-md md:shadow-none transition-all duration-300 ease-in-out ${
        ...
        >
          ...
          <a
            href="/cart"
            className="flex items-center md:hidden gap-2 hover:text-black hover:bg-gray-100 transition-colors duration-200 py-2 px-6 md:py-0 md:px-0 rounded focus:outline-none focus:ring-2 focus:ring-black/30"
            onClick={() => setIsMenuOpen(false)}
          >
