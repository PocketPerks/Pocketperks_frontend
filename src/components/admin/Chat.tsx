...
const initialMessages = [
  {
    sender: 'TOBY',
    time: '12:45',
    message: 'Hi, i had a question about my product',
    status: 'Delivered',
    isYou: false,
  ...
  },
  {
    sender: 'Anakin',
    time: '12:49',
    message: 'Of course! What’s your question about the product?',
    status: 'Seen at 13:06',
    isYou: true,
    avatar: '/logos/pfp.jpg',
  },
];
...
const contacts = [
  // Pending
  {
    ...
    name: 'Aditya',
    avatar: '/logos/pfp.jpg',
    lastMessage: 'last message they sent or new message',
    tab: 'Pending',
    unread: 2,
  },
  {
  ...
  },
  {
    ...
    name: 'Sara',
    avatar: '/logos/pfp.jpg',
    lastMessage: 'I have another question.',
    tab: 'Visited',
    unread: 0,
  },
  {
        ...
        {messages.map((bubble: Message, index: number) => (
          <div
            ...
            className={`flex items-end gap-2 ${
              bubble.isYou ? 'justify-end' : 'justify-start'
            }`}
          >
            {/* Sender's avatar */}
            {!bubble.isYou && (
